    ...
    <>
      <Container class1="home-wrapper-1 py-5">
        <div className="row">
          ...
          <div className="col-6">
            <div className="d-flex flex-wrap gap-10 gap-10 align-items-center">
            ...
            <div className="famous-card position-relative">
              ...
              <div className="famous-content position-absolute">
                ...
                <p className="text-dark">
                  Now in Green. From $999.00 or $41.62/mon for 24 mon Foonote*
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-3">
            <div className="famous-card position-relative">
              ...
              <div className="famous-content position-absolute">
                ...
                <p className="text-dark">
                  From $699 or $116.58 month for 12 month
                </p>
              </div>
            </div>
          </div>
      ...
      <Container class1="popular-wrapper py-5 home-wrapper-2">
        <div className="row">
          <div className="col-12">
            <h3 className="Container-heading">Our Popular Production</h3>
          </div>
        </div>
        <div className="row">
          <ProductCard />
